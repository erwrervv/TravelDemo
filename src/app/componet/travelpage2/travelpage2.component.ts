...
export class Travelpage2Component {
  ...
  travelList = [
    ...
    {
      imageUrl: 'assets/images/基隆景點八斗子觀光漁港.jpg',
    ...
    {
      imageUrl: 'assets/images/基隆景點和平島公園.jpg',
      altText: '基隆景點和平島公園圖片',
      title: '基隆景點和平島公園',
    ...
    {
      imageUrl: 'assets/images/基隆景點外木山海岸.jpg',
      altText: '基隆景點外木山海岸圖片',
      title: '基隆景點外木山海岸',
    ...
    {
      imageUrl: 'assets/images/基隆景點阿拉寶灣.jpg',
      altText: '基隆景點阿拉寶灣圖片',
      title: '基隆景點阿拉寶灣',
    ...
    {
      imageUrl: 'assets/images/基隆景點潮境公園.jpg',
      altText: '基隆景點潮境公園圖片',
      title: '基隆景點潮境公園',
